#!/usr/bin/env python3
"""Validate the model subagent audit output and merge it into CuratedFR.jsonl.
...
def main():
    ...
    print(f"dopisane do CuratedFR.jsonl: {len(fresh)} (lacznie {len(existing)+len(fresh)})")
    return 0
